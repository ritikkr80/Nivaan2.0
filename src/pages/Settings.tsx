      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="p-4 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Bell className="w-5 h-5 text-mild-blue-600" />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Moon className="w-5 h-5 text-mild-blue-600" />
          ...
          <Card className="p-4 bg-white/60 dark:bg-gray-800/60">
            ...
            <div className="space-y-3">
              <Button variant="ghost" className="w-full justify-start p-0">
                <Shield className="w-5 h-5 text-mild-blue-600 mr-3" />
                Privacy Policy
              </Button>
              <Button variant="ghost" className="w-full justify-start p-0">
                <Shield className="w-5 h-5 text-mild-blue-600 mr-3" />
          ...
          <Card className="p-4 bg-white/60 dark:bg-gray-800/60">
            ...
            <div className="space-y-3">
              <Button variant="ghost" className="w-full justify-start p-0">
                <HelpCircle className="w-5 h-5 text-mild-blue-600 mr-3" />
                Help Center
              </Button>
              <Button variant="ghost" className="w-full justify-start p-0">
                <HelpCircle className="w-5 h-5 text-mild-blue-600 mr-3" />
